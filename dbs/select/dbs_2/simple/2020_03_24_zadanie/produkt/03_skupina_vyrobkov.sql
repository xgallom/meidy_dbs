SELECT dod_vyr.nazov                    AS 'Skupina Výrobkov',
...
FROM (SELECT dod_vyr.nazov,
      ...
      FROM (SELECT dod_vyr.skupina_vyrobku_id,
                   skupiny_vyrobkov.nazov,
                   dod_vyr.vyrobok_id,
                   dod_vyr.vyr_cena,
                   dod_vyr.pred_cena,
                   dod_vyr.mnozstvo
            FROM skupiny_vyrobkov
                 ...
                 (SELECT typy_vyrobkov.skupina_vyrobku_id,
                  ...
                  FROM typy_vyrobkov
                       ...
                       ON typy_vyrobkov.id = dod_vyr.typ_vyrobku_id
                 ) AS dod_vyr
                 ON skupiny_vyrobkov.id = dod_vyr.skupina_vyrobku_id
           ) AS dod_vyr
               LEFT JOIN
      ...
      GROUP BY dod_vyr.skupina_vyrobku_id
     ) AS dod_vyr
